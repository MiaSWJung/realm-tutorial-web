...
const DeleteTaskMutation = gql`
    mutation DeleteTask($taskId: ObjectId!){
      deleteTask: deleteOneTask(query: {_id: taskId}){
        _id
        _partition
        name
        status
...
function useAddTask(project) {
  ...
  const addTask = async (task) => {
      // TODO: Use the functions returned from the addTaskMutation hook to execute the mutation.
...
function useUpdateTask(project) {
  ...
  // TODO: Use the functions returned from the updateTaskMutation to execute the mutation.
